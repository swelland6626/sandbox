...
CUDA_VISIBLE_DEVICES=6 python cyclegan_resnet.py
'''
...
from tensorflow.keras.layers import GlobalAveragePooling3D, Lambda
import datetime
...
class CycleGAN():
    def __init__(self):
        ...
        self.data_loader = DataLoader(dataset_name=self.dataset_name,
                                      img_res=(self.img_rows, self.img_cols),augment=False)
        ...
        idem_B = GlobalAveragePooling3D()(x)

        y = Lambda(lambda y: (y[0] - y[1])**2)([img_idem_A, fake_A])
        idem_A = GlobalAveragePooling3D()(y)
