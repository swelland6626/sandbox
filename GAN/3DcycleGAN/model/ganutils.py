...
def upsample_1(
    ...
    x = layers.UpSampling3D(size=strides,interpolation="nearest")(x)
    x = layers.Conv3D(
        filters,
        kernel_size,
        padding=padding,
...
def get_resnet_generator(
    ...
    x = layers.Conv2D(1, (7, 7, 7), padding="valid")(x)
...
class CycleGan(keras.Model):
    ...
    def train_step(self, batch_data):
        ...
        with tf.GradientTape(persistent=True) as tape:
            ...
            # should add idempotent loss in here
